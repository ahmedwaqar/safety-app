// Generated from app/praxis-studio.ts. Do not edit this file directly.
...
function parseProject(text) {
  ...
  if (!data || !Array.isArray(data.components) || !Array.isArray(data.hazards) || !Array.isArray(data.fmea))
    throw new Error("The JSON file is not a valid Praxis Studio workspace.");
